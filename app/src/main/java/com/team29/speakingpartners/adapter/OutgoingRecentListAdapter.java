...
public class OutgoingRecentListAdapter extends RecyclerView.Adapter<OutgoingRecentListAdapter.RecentListViewHolder> {
    ...
    public OutgoingRecentListAdapter(Context mContext) {
        this.mContext = mContext;
    }

    public OutgoingRecentListAdapter(Context mContext, List<RecentListModel> mLists) {
        this.mContext = mContext;
        this.mLists = mLists;
    }

    public OutgoingRecentListAdapter(Context mContext, List<RecentListModel> mLists, RecentItemClickListener recentItemClickListener) {
        this.mContext = mContext;
        this.mLists = mLists;
    ...
    public interface RecentItemClickListener {
        ...
        void setOnItemLongClick(RecentListModel model);
