...
public class ImagePickerHelper {
    ...
    private static final int CHOOSE_CODE = 8191;

    public static void startSelectImageIntent(final Activity activity) {
        activity.startActivityForResult(getImageChooserIntent(activity), CHOOSE_CODE);
    }

    private static Intent getImageChooserIntent(final Activity activity) {
        ...
        Intent chooserIntent = Intent.createChooser(mainIntent, "Select Application");
    ...
    private static Uri getCaptureImageOutputUri(Activity activity) {
        ...
        Log.d(TAG, "Image URI = " + outputFileUri.toString());
