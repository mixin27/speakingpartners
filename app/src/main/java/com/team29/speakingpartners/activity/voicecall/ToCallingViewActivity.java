...
public class ToCallingViewActivity extends AppCompatActivity {

    public static final String TAG = ToCallingViewActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_to_calling_view);
        ...
        btnLocalAudio = findViewById(R.id.to_btn_local_audio);
        ...
        btnEndCall = findViewById(R.id.to_btn_end_call);
